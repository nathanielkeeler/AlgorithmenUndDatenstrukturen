...
class USD_Muenze extends USD implements Muenze {
	...
	eigenschaften select(double wert) {
		final eigenschaften daten[] = { new eigenschaften(0.01, 2.50, 19.05, 1.55),
				new eigenschaften(0.05, 5.00, 21.21, 1.95), new eigenschaften(0.10, 2.27, 19.91, 1.35),
				new eigenschaften(0.25, 5.67, 24.26, 1.75), new eigenschaften(0.50, 11.34, 30.61, 2.15),
